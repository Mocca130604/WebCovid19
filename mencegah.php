...
<div class="card mt-4">
    <div class="card-header bg-danger  text-white text-center">
     <b class="text">cara mencegah Covid </b>
        </div>
            <div class="card-body">
    <div class="container text-center">
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="col-md-4">
                        <img src="img/rumah.png" style="width: 150px">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <h2>Menjaga Jarak Min 1M</h2>
                        </div>
                        <div class="col-md-4">
                        <img src="img/jagajarak.png" style="width: 145px">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="bg-success box text-white mt-4">
                <div class="row">
                    <div class="col-md-6">
                        <h2>Mencuci Tangan</h2>
                        </div>
                        <div class="col-md-4">
                        <img src="img/cucitangan.png" style="width: 150px">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <h2> Menjaga Kebersihan</h2>
                        </div>
                        <div class="col-md-4">
                        <img src="img/bersibersih.png" style="width: 150px">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="col-md-4">
                        <img src="img/masker.png" style="width: 150px">
                        </div>
                    </div>
                </div>
            </div>
